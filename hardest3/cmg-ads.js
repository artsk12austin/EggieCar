...
function init() {
  ...
  script.src = "/games/hardest3/cmg-prebid.js";
  script.async = false;
  document.head.appendChild(script);
  var script2 = document.createElement("script");
  script2.src = "/games/hardest3/cmg-headerbidding.js";
  script2.async = false;
  document.head.appendChild(script2);
  console.log("added cmg-headerbidding");
  var script3 = document.createElement("script");
  script3.src = "/games/hardest3/ima3_debug.js";
  script3.async = false;
  ...
  $(document).ready(function () {
    ...
    var html = '<style>#adcontainer >div {width:100% !important;height:100%;position:absolute;}</style>' +
	  ...
	  '<div id="afg_preloader" >' +
	    '<div id="container123" style="left: 50%;top: 50%;width: 100%;transform: translate(-50%,-50%);position: absolute">' +
      ...
      */
       ...
       */
       ...
       if(!cmgAInvD) {
         ...
         var gameURL = parentURL.split('/').pop();
       ...
       var midrollIntervalId = setInterval(function () {
         ...
         if (seconds_left <= 0) {
           if (jQuery(".continue-button-link") != null) {
             ...
             jQuery(".continue-button-link").html('<a href="javascript:cmg_remove_madg();" style="color:#f1db00;text-transform:uppercase"><div class="continue-link-yellow">RETURN to Game <span style="font-family:Times New Roman;">&#x25BA;</span></div></a>');
           }
